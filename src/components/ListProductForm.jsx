...
export default function ListProductForm() {
    ...
    const addInsecticide = () => {
        if (
            newInsecticide.trim() &&
            !insecticides.includes(newInsecticide.trim())
        ) {
    ...
    const addFertilizer = () => {
        if (
            newFertilizer.trim() &&
            !fertilizers.includes(newFertilizer.trim())
        ) {
        ...
        try {
            ...
            if (formData.images.length > 0) {
                ...
                for (let i = 0; i < formData.images.length; i++) {
                    ...
                    const fileName = `${formData.name.replace(/\s+/g, "_")}_${
                        i + 1
                    }.${file.name.split(".").pop()}`;

                    const { data: uploadData, error: uploadError } =
                        await uploadProductImage(file, fileName);
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <div className="text-center mb-8">
                    ...
                    <p className="text-xl text-gray-600">
                        Share your fresh farm products with our community
                    </p>
                </div>
                    ...
                    <CardContent>
                        <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="irrigationMethod">
                                        Irrigation Method *
                                    </Label>
                                    <Select
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="location">
                                    Product Location (Where to pick up) *
                                </Label>
                                <Input
                                    id="location"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2 mb-2">
                                    <Input
                                        value={newFertilizer}
                                        onChange={(e) =>
                                            setNewFertilizer(e.target.value)
                                        }
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2 mb-2">
                                    <Input
                                        value={newPest}
                                        onChange={(e) =>
                                            setNewPest(e.target.value)
                                        }
                                        placeholder="e.g., Aphids, Powdery Mildew"
                                        onKeyPress={(e) =>
                                            e.key === "Enter" &&
                                            (e.preventDefault(), addPest())
                                        }
                                    />
                                    <Button
                                        type="button"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2 mb-2">
                                    <Input
                                        value={newPesticide}
                                        onChange={(e) =>
                                            setNewPesticide(e.target.value)
                                        }
                                        placeholder="e.g., Copper Sulfate, Neem Oil"
                                        onKeyPress={(e) =>
                                            e.key === "Enter" &&
                                            (e.preventDefault(), addPesticide())
                                        }
                                    />
                                    <Button
                                        type="button"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2 mb-2">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setNewInsecticide(e.target.value)
                                        }
